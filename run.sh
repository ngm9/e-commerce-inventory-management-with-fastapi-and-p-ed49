...
docker exec shopflow_pg psql -U shopuser -c "CREATE USER shopuser WITH PASSWORD 'shoppass';" 2>/dev/null || true
docker exec shopflow_pg psql -U shopuser -c "CREATE DATABASE shopflow OWNER shopuser;" 2>/dev/null || true
